...
BMW-specific **vehicle order / equipment** from [mdecoder.com](https://www.mdecoder.com/). UK car-type / MOT is **[car-fastcarcheck.md](car-fastcarcheck.md)**. mdecoder is **VIN**-based.
...
- Seq **13**; Depends-on **`cars`**. Poll 30s; cap 2 minutes. BMW gate on Make or VIN prefix. Replace JSON. Nickname never overwritten. No live CI network.

## Implementation notes for an agent

Requires `cars` **Status** `done`.

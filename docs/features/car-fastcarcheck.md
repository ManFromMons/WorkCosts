...
- **Id:** `docs/features/car-fastcarcheck.md`
- **Seq:** 14
- **Depends-on:** `cars`, `car-details`
- **Status:** draft
- **PR:** none
...
- Seq **14**; Depends-on **`cars`**, **`car-details`**. Nickname never overwritten. mdecoder remains Seq 13. Status stays **draft** until resumed.

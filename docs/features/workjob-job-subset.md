...
- **Id:** `docs/features/workjob-job-subset.md`
- **Seq:** 15
- **Depends-on:** none
...
**GarageJob later collates work items** (the copied instance set) and builds behaviour around that set. That collation, start-work chrome, and ItemOfWork logging are **not this Seq** ([item-of-work-ui.md](item-of-work-ui.md) — refine later).
